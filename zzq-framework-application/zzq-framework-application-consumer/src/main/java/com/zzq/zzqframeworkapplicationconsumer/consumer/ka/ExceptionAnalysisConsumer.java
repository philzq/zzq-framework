...
public class ExceptionAnalysisConsumer {
    ...
    // 消费监听
    @KafkaListener(topics = {"#{'${kaKafkaTopicExceptionAnalysis}'}"}, groupId = KafkaConfigConstant.KA_GROUP_ID, containerFactory = KafkaConfigConstant.KA_KAFKA_CONTAINER_FACTORY)
