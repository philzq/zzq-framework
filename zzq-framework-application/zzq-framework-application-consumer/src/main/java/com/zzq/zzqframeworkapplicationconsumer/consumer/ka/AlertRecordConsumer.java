 ...
 * @author zhouzhiqiang
 * @version 1.0
 * @date 2022-03-21 9:47
 */
@Component
public class AlertRecordConsumer {

    // 消费监听
    @KafkaListener(topics = {"#{'${kaKafkaTopicAlertRecord}'}"}, groupId = KafkaConfigConstant.KA_GROUP_ID, containerFactory = KafkaConfigConstant.KA_KAFKA_CONTAINER_FACTORY)
