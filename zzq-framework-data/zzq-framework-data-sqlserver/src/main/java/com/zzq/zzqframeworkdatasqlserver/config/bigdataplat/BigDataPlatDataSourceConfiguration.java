...
import com.zzq.zzqframeworkdatasqlserver.config.properties.DruidProperties;
...
public class BigDataPlatDataSourceConfiguration {
    ...
    @ConfigurationProperties(prefix = "spring.datasource.druid.bigdataplatsqlserver.one")
