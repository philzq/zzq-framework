package com.zzq.zzqframeworkdatamysql.config;
...
public interface DataSourceConfigConstant {
    ...
    /*#############################bigdataplat#####################################*/
    //扫描包路径
    String BIGDATAPLAT_BASE_PACKAGES = "com.zzq.bigdataplatdatamysql.mapper.bigdataplat";
    //mapper.xml路径
    String BIGDATAPLAT_MAPPER_LOCATION = "classpath*:mybatis/shardingtest/*.xml";
    //工厂bean名字
